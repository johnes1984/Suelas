...
!function ($) {
  ...
  */
  var Validator = function ( options ) {
    ...
    */
    this.messages = {
        defaultMessage: "Este valor parece ser válido."
      , type: {
          ...
          , dateIso:    "Este valor debe ser una fecha válida (AAAA-MM-DD)."
          , alphanum:   "Este valor debe ser alfanumérico."
          , phone:      "Este valor debe ser un número de teléfono válido."
        }
      , notnull:        "Este valor no debe ser nulo."
      , notblank:       "Este valor no debe estar en blanco."
      , required:       "Este valor es necesario."
      , regexp:         "Este valor parece ser válido."
    ...
    , removeError: function ( constraintName ) {
      ...
      this.options.animate ? $( liError ).fadeOut( this.options.animateDuration, function () {
        ...
        if ( that.ulError && $( that.ulError ).children().length === 0 ) {
          $(that.ulError).parent('div').removeClass("error");
          that.removeErrors();
        } } ) : $( liError ).remove();
    ...
    */
    , addError: function ( error ) {
      for ( var constraint in error ) {
        ...
        $(this.ulError).parent('div').addClass("error");
      }
    }
  ...
  */
  $.fn.parsley.defaults = {
    ...
    , errorClass: 'parsley-error form-error'               // Class name on each invalid input
